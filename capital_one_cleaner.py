...
categories = {
    "Travel": ["hotel", "flight", "vacation", "travel", "rental car", "rental cars"],
    "Gas": ["gallon", "gas"],
    "Groceries & Dining": ["grocery store", "dining", "food delivery", "restaurant", "entertainment", "streaming service"],
    "Retail & Entertainment": ["T-Mobile", "REI", "Williams-Sonoma", "Pottery Barn", "West Elm", "Bass Pro Shops", "Cabela’s", "BJ’s", "Kohl’s"],
    "All Purchases": [
        "all other", 
        "every purchase", 
        "all purchases", 
